...
var DEFAULT_URL = '';
//DEFAULT_URL = 'examples/06221.pdf';
var DEFAULT_SCALE = 'page-actual';
...
var PDFView = {
  ...
  open: function pdfViewOpen(url, scale, password,
    ...
    var upload_url = $('#upload_url', parent.document).val();
    ...
    if($('#fileInput').val().length > 0)
    {
      ...
      $.ajax({
        ...
        success: function(data){
            ...
            $('#upload_url', parent.document).val(received.upload_url);
            //upload_url = received.upload_url;
            //alert(upload_url);
      ...
      $.ajax({
        ...
        success: function(data){
          var received = $.parseJSON(data);
         // alert(received.blob_key);
          $('#pdf_url', parent.document).val(received.blob_key);
        }
      });
      ...
      $.ajax({
        ...
        success: function(data){
          var received = $.parseJSON(data);
          $('#upload_url', parent.document).val(received.upload_url);
          //alert(received.upload_url);
          //form.method = received.upload_url;
          //alert(received.blob_key + "lol");
  ...
  PDFView.animationStartedPromise.then(function() {
    ...
    if (container.clientWidth > 0) {
      ...
      container.setAttribute('style', 'min-width: ' + width + 'px; ' +
                                      'max-width: ' + width + 'px; visibility:hidden;');
    }
